...
<nav aria-label="breadcrumb" class="d-flex justify-content-between">
  ...
  <div class="mx-3">
    <a href="/createincoming" class="btn bg-blue text-white">Tambah Baru</a>
</div>
</nav>
<div class="card mb-4">
  <div class="card-header pb-0">
      <div class="d-flex justify-content-between flex-column flex-sm-row">
          <div class="card-title">
              <h5 class="text-nowrap mb-0 fw-bold">001/HMDP/IV/2024</h5>
...
<div class="card mb-4">
  <div class="card-header pb-0">
      <div class="d-flex justify-content-between flex-column flex-sm-row">
          <div class="card-title">
              <h5 class="text-nowrap mb-0 fw-bold">014/HMDJ/IV/2024</h5>
              <small class="text-black">
                  HIMADA Jambi |
                  <span class="text-secondary">{{ __() }}</span> Undangan |
                  Pembukaan Seni Musik
              </small>
          </div>
          <div class="card-title d-flex flex-row">
              <div class="d-inline-block mx-2 text-end text-black">
...
<div class="card mb-4">
  <div class="card-header pb-0">
      <div class="d-flex justify-content-between flex-column flex-sm-row">
          <div class="card-title">
              <h5 class="text-nowrap mb-0 fw-bold">022/HMDR/IV/2024</h5>
              <small class="text-black">
                  HIMADA Riau |
                  <span class="text-secondary">{{ __() }}</span> Undangan |
